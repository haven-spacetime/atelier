  ...
  const jobs = await Promise.all([
    ...
    prisma.job.create({
      data: {
        ...
        description: 'Complete color change wrap in 3M Satin Black with PPF base layer on high-impact areas.',
        estimatedHours: 40,
        actualHours: 44,
    ...
    prisma.job.create({
      data: {
        ...
        description: 'XPEL Stealth PPF (matte finish on Rosso Corsa), followed by Ceramic Pro Gold package.',
        estimatedHours: 35,
        actualHours: 20,
    ...
    prisma.job.create({
      data: {
        ...
        description: 'Full body Satin PPF to maintain factory matte Papaya. Extra care on aero surfaces.',
        estimatedHours: 32,
        actualHours: 34,
    ...
    prisma.job.create({
      data: {
        ...
        description: 'Full color change from Graphite Grey to Avery Satin Khaki Green. Chrome delete in Satin Black.',
        estimatedHours: 45,
    ...
    prisma.job.create({
      data: {
        ...
        description: 'Full color change to Inozetek Midnight Purple. Customer wants process documented for content.',
        estimatedHours: 30,
    ...
    prisma.job.create({
      data: {
        ...
        description: 'Pre-delivery ceramic coat. Dealership wants quote for full exterior + wheels.',
        estimatedHours: 6,
        quotedPrice: 1800,
        photos: JSON.stringify([]),
      },
    ...
    prisma.job.create({
      data: {
        ...
        description: 'XPEL XR Plus ceramic tint all around (15% rear, 35% front). Ceramic Pro Sport on exterior.',
        estimatedHours: 10,
  ...
  const invoices = await Promise.all([
    ...
    prisma.invoice.create({
      data: {
        ...
        lineItems: JSON.stringify([
          ...
          { description: 'PPF Base Layer — High-Impact Areas', qty: 1, unitPrice: 2000, total: 2000 },
        ]),
        subtotal: 8500,
        tax: 743.75,
        total: 9243.75,
    ...
    prisma.invoice.create({
      data: {
        ...
        lineItems: JSON.stringify([
          { description: 'Partial PPF Package — Nose/Mirrors/Rockers', qty: 1, unitPrice: 2200, total: 2200 },
        ]),
        subtotal: 2200,
        tax: 192.50,
        total: 2392.50,
  ...
  const inventoryVehicles = await Promise.all([
    prisma.inventoryVehicle.create({
      data: {
        ...
        costBasis: 195000,
        status: 'AVAILABLE',
        description: 'Extremely clean single-owner EVO. Full PPF, ceramic, and tint done in-house. Ready for the showroom floor.',
        photos: JSON.stringify(['https://images.unsplash.com/photo-1682825132000-4670b89ee97b?w=800&q=80']),
      },
    }),
    prisma.inventoryVehicle.create({
      data: {
        ...
        costBasis: 172000,
        status: 'AVAILABLE',
        description: 'MSO spec with carbon aero kit. Minor stone chips on nose — included PPF before listing.',
        photos: JSON.stringify(['https://images.unsplash.com/photo-1522441040106-2621f423b5eb?w=800&q=80']),
      },
    }),
    prisma.inventoryVehicle.create({
      data: {
        ...
        costBasis: 215000,
        status: 'PENDING',
        description: 'PTS Shark Blue with Weissach package. Deposit received — awaiting buyer financing.',
        photos: JSON.stringify(['https://images.unsplash.com/photo-1614162692292-7ac56d7f7f1e?w=800&q=80']),
      },
    }),
    prisma.inventoryVehicle.create({
      data: {
        ...
        photos: JSON.stringify(['https://images.unsplash.com/photo-1592198084033-aade902d1aae?w=800&q=80']),
      },
    }),
  ])
  ...
  const campaigns = await Promise.all([
    prisma.marketingCampaign.create({
      data: {
        ...
        message: 'Hey! Atelier Motors is running 15% off full PPF installs through the end of March. Book your appointment today — limited bay availability. Reply STOP to opt out.',
    ...
    prisma.marketingCampaign.create({
      data: {
        ...
        message: 'Just landed: 2019 Ferrari 488 Pista in Blu Tour de France. 3,100 mi, full PPF, collector-grade. DM for details before it hits the market.',
